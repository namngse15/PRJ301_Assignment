 ...
 * @author tenhik
 */
@WebServlet(name = "ProfilePasswordController", urlPatterns = {"/changePassword"})
public class ProfilePasswordController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account.getPassword().equals(oldPass)) {
            checkPass=adb.updatePassword(newPass, account.getUsername(), account.getEmail());
            request.setAttribute("checkPass",checkPass);
        }
        //change pass success return to login        
        if(checkPass==true) {
